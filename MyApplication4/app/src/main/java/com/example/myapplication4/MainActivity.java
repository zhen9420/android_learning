...
import com.example.myapplication4.SaveLogin;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                boolean isSaveSuccess= SaveLogin.saveUserInfo(MainActivity.this,account,password);
                if (isSaveSuccess){
                ...
                Map<String,String> userInfo=SaveLogin.getUserInfo(MainActivity.this);
                if(userInfo!=null){
